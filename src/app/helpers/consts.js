...
export const PLACEMENT_TYPE_LASERS = "Lasers"
export const PLACEMENT_TYPE_CONVERSATION = "Conversation"
export const PLACEMENT_TYPE_DEATH_COLLIDER = "DEATH_COLLIDER"
...
export const WATER_TYPES = {
  ...
  WATER_ANIM_A: "WATER_ANIM_A",
  WATER_ANIM_B: "WATER_ANIM_B",
  WATER_ANIM_C: "WATER_ANIM_C",
  WATER_DANK: "WATER_DANK"
}
...
export const WALL_TYPES = {
  ...
  WALL_INT_JUNCTION_TOP: "WALL_INT_JUNCTION_TOP",
  WALL_CELL_DOORS: "WALL_CELL_DOORS",

  WALL_INT_TR: "WALL_INT_TR",
  WALL_INT_TL: "WALL_INT_TL",
  WALL_INT_T_L: "WALL_INT_T_L",
  WALL_INT_T_R: "WALL_INT_T_R",
  WALL_INT_T_BOTTOM: "WALL_INT_T_BOTTOM",
  BATHROOM_DOOR: "BATHROOM_DOOR",
  BATHROOM_DOOR_L : "BATHROOM_DOOR_L",
  BATHROOM_DOOR_R : "BATHROOM_DOOR_R",
...
export const SET_DRESSING_TYPES = {
  ...
  SINK: "SINK",
  HOR_BED: "HOR_BED",
  ELEVATOR_DOOR_L: "ELEVATOR_DOOR_L",
  ELEVATOR_DOOR_C: "ELEVATOR_DOOR_C",
  ELEVATOR_DOOR_R: "ELEVATOR_DOOR_R",
  BATH_SIGN: "BATH_SIGN",
  TP_ROLL: "TP_ROLL",
  TRASH: "TRASH",
  COMPUTER_DESK: "COMPUTER_DESK",
  BOOKSHELF_VERT: "BOOKSHELF_VERT",
  LASER_WALL_OFF: "LASER_WALL_OFF",
  CONSOLE_WALL_GREEN: "CONSOLE_WALL_GREEN",
  SHELF_LEFT: "SHELF_LEFT",
  TABLE_LEFT: "TABLE_LEFT",
  SCREEN_TEXT1: "SCREEN_TEXT1",
  SCREEN_TEXT2: "SCREEN_TEXT2",
  CHEETOS_DRESSING: "CHEETOS_DRESSING"

}

export const CONVERSATION_TYPES = {
  AJ_CONVO_1: "AJ_CONVO_1",
  GUARD_CONVO: "GUARD_CONVO",
  TOILET_THOUGHT: "TOILET_THOUGHT",
...
export const BACTA_TYPES ={
  BACTA_GREEN: "BACTA_GREEN",
  BACTA_PINK: "BACTA_PINK",
}

export const PIPE_TYPES = {
  PIPE_VERT: "PIPE_VERT",
  PIPE_VERT_OUT: "PIPE_VERT_OUT",
  PIPE_VERT_IN: "PIPE_VERT_IN",
  PIPE_TURN1: "PIPE_TURN1",
  PIPE_TURN2: "PIPE_TURN2",
  PIPE_HOR1: "PIPE_HOR1",
  PIPE_HOR2: "PIPE_HOR2",
  PIPE_DRAIN: "PIPE_DRAIN",
  PIPE_DRAIN1: "PIPE_DRAIN1",
  PIPE_DRAIN2: "PIPE_DRAIN2",
  PIPE_DRAIN3: "PIPE_DRAIN3",
  PIPE_DRAIN4: "PIPE_DRAIN4",
  PIPE_DRAIN5: "PIPE_DRAIN5",
}

export const LASER_TYPES = {
  LASER_WALL_ON: "LASER_WALL_ON",
  LASER_WALL_OFF: "LASER_WALL_OFF",
  LASER_ON: "LASER_ON",
}
...
export const FLOOR_TYPES = {
  ...
  FLOOR_RED: "FLOOR_RED",
  FLOOR_WARNING_VERT1: "FLOOR_WARNING_VERT1",
  FLOOR_WARNING_VERT2: "FLOOR_WARNING_VERT2",
  FLOOR_WARNING_VERT3: "FLOOR_WARNING_VERT3",
  FLOOR_GOO: "FLOOR_GOO",
}
